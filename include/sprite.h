...
void LONG_CALL FreeAndReserveSpritePalettes(void);
void LONG_CALL ResetSpriteData(void);
void LONG_CALL AnimateSprites(void);
void LONG_CALL BuildOamBuffer(void);
void LONG_CALL LoadOam(void);
void LONG_CALL ProcessSpriteCopyRequests(void);
