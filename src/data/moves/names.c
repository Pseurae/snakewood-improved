...
const u8 gMoveNames[][13] = {
    ...
    [MOVE_SKULLBREAKER] = _("SKULLBREAKER"),
    ...
    [MOVE_ICEBREATH] = _("ICE BREATH"),
    [MOVE_DETECT] = _("DETECT"),
    [MOVE_BONE_RUSH] = _("BONE RUSH"),
    [MOVE_DATA_STREAM] = _("DATA STREAM"),
    ...
    [MOVE_SHADOW_SWIPE] = _("SHADOW SWIPE"),
    ...
    [MOVE_BRIGHT_IDEA] = _("BRIGHT IDEA"),
    [MOVE_CRAZY_BOLT] = _("CRAZY BOLT"),
    [MOVE_AFRO_BREAK] = _("AFRO BREAK"),
    [MOVE_FEATHER_DANCE] = _("FEATHERDANCE"),
    [MOVE_TEETER_DANCE] = _("TEETER DANCE"),
    [MOVE_FRICTIONKICK] = _("FRICTIONKICK"),
    ...
    [MOVE_CRYSTALSTORM] = _("CRYSTALSTORM"),
