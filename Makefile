...
CFLAGS = -Wall -std=c99 -O2 -Iinclude -mlong-calls -g -mthumb -mno-thumb-interwork -march=armv4t -mcpu=arm7tdmi -mtune=arm7tdmi -x c -c -Wparentheses -Wno-unused -Werror
